# NEON PAW — Demo-Ready MVP v1 Checkpoint

**Date:** 2026-05-03
**Branch:** main
**Latest Commit:** 2d82c97
**Status:** Demo-ready
...
| 17 | Memory privacy notice ("LOCAL ONLY" label, privacy footer) | Done |
| 18 | "How Memory Works" expandable section | Done |
| 19 | First-time memory save notification | Done |
| 20 | Clear-all confirmation with local browser context | Done |
...
5. Expand "HOW MEMORY WORKS" to see explanation of how memories are stored and used
6. Say: "我叫什么？"
...
| No database/cloud sync | All state in localStorage | Phase 8+ |
| Memories are localStorage only | Lost if browser data cleared | Phase 8+ |
